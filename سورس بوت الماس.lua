...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صلاح'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "CR_T2")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝘴ꪖꪶꪖꫝ")  
...
send(msg.chat_id_, msg.id_,'⌔ تم تحديث السورس \n⌔ لديك اخر اصدار لسورس صلاح\n⌔ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌔ اصدار سورس صلاح \n⌔ الاصدار »{ v 1.5}')
end
if text == 'صلاح مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[Dev Diamond](t.me/BK_ZT)
]] 
keyboard = {}  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/CR_T2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/BK_ZT25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n⌔ العضو » ['..result.title_..'](t.me/'..(username or 'CR_T2')..')'
status  = '\n⌔ تم ترقيته مطور'
...
usertext = '\n⌔ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CR_T2')..')'
status  = '\n⌔ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CR_T2')..') \n⌔ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⌔ العضو : {["..data.first_name_.."](T.ME/CR_T2)}\n⌔ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌔ عذرا » {["..data.first_name_.."](T.ME/CR_T2)}\n⌔ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = {
  "غيرت صورتك ليه يا حلو ",
  "منور طالع حلو في الصوره الجديده",
  "ها غيرت صورتك 🤔😹",
  "كوبتغير صورتك ليه يعم  😹🌚",
  "غيرت صورتك ليه اتعاركت مع الحب ولا اي 😒😂",
  "ايهالقرف دا رجع الصوره التانيه يعم 🙂😂",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
...
local Text = [[
★W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝒅𝒆𝒔𝒂★
⌔ مرحب بيك في سورس الماس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Salah Siria️',url="t.me/BK_ZT"}},
{{text = 'Source Diamond️',url="t.me/CR_T2"}},
{{text = 'جروبي تع هناك️',url="t.me/bajwkk"}},
{{text = 'بوت السورس الرسمي️', url="t.me/Sheyoubot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/CR_T2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مطور السورس' or text == 'صلاح حمدان' or text == 'صلاح' then
local Text = [[
[DEV Salah Siria](t.me/BK_ZT)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Salah Siria',url="t.me/BK_ZT"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝘴ꪖꪶꪖꫝ', url="t.me/BK_ZT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BK_ZT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب صلاح' then
local Text = [[
Source Diamond 
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌔ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CR_T2')..') \n⌔ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CR_T2')..') \n⌔ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, "⌔ لا يمكنك حظر المبرمج صلاح\n")
return false 
end
...
send(msg.chat_id_, msg.id_, "⌔ لا تسطيع حظر المبرمج صلاح عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1295339524) then
send(msg.chat_id_, msg.id_, "⌔ لا يمكنك كتم المبرمج صلاح\n")
return false 
end
if result.sender_user_id_ == tonumber(859213488) then
...
if tonumber(result.id_) == tonumber(1295339524) then  
send(msg.chat_id_, msg.id_, "⌔ لا تسطيع كتم المبرمج صلاح عام")
return false 
end
if tonumber(result.id_) == tonumber(859213488) then  
...
if Get_info then
local TextS = "\n⌔ اهلا بك في متجر ملفات صلاح\n⌔ ملفات السورس ↓\n≪━━━━━━𝘴ꪖꪶꪖꫝ━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘴ꪖꪶꪖꫝ━━━━━━≫\n⌔ علامة تعني { ✔️ } ملف مفعل\n⌔ علامة تعني { ✖ } ملف معطل\n⌔ قناة سورس صلاح ↓\n".."⌔ [اضغط هنا لدخول](t.me/CR_T2) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"⌔ عذرا الملف لايدعم سورس صلاح \n") 
end
return false
end
...
if text == ("مسح قائمه صلاح") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⌔ تم مسح قائمه صلاح')
return false
end

if text == 'قائمه صلاح' and Sudo(msg) then
...
if text == ("رفع صلاح") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صلاح @(.*)$") and Sudo(msg) then
local username = text:match("^رفع صلاح @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صلاح (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع صلاح (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل صلاح") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صلاح @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل صلاح @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صلاح (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل صلاح (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌔ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CR_T2')..')'
status  = '\n⌔ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌔ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌔ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CR_T2')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'CR_T2')..')'..'\n⌔ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صلاح').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'صلاح')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."CR_T2:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."CR_T2:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CR_T2:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CR_T2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CR_T2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CR_T2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس صلاح يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'صلاح').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CR_T2')..')'
local iduser = result.sender_user_id_
...
Text = '\n⌔ تم تعطيل امر اطردني اترزع هنا بقى مفيش خروج 😹'
else
...
{
{text = 'Source Diamond ', url="t.me/CR_T2"},
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝘴ꪖꪶꪖꫝ━━━━━━≫ٴ\n★ [ 𝘴ꪖꪶꪖꫝ ](t.me/CR_T2)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'صلاح')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..'ايه رأيك في دا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'جايبينو من انهي سلة زباله دا','راجل زي الفل اهو','ا حكاك يعم سيبك منو', 'هو فين دا مش شايفو 🙂😂','محبوب بصوت عادل شكل 😂 ','قاعد يريل ع البنات من الصبح 😹️','مش تمام ابعد عنو 😂','اجدع واحد في الروم 🤓❤️','بيشتمني علطول ☹️','مش بيحترم الناس اللي موجوده في الروم ', 'دا واحد قذر 🙄😒','مش بطيقو 🙂','جامد كدا طالعلي 🤓' } 
...
function FunBot(extra, result, success) 
local Fun = {'ايوه بموت فيه 🌚❤ ','ولا بطيقو وانت الصادق ',' يع لا ','لو تدوني الفرصه بس اخلصكم منو','مش بحب خولات 🙂😂','دا فردتي دا 🌚❤','ئووووووووف اموتعليه ','ايععععععععع','طب اقعد ساكت تعرف 😒','مش بحب مخابيل','بحب صلاح وبس','لٱ مش بحبو','بله دي جهره تقولي بتحبو ؟ ','انت فاضي مش لاقي حاجه تعملها جاي تقولي بحبه او لا يعم شوف حالك','دا تحويشة عمري دا 🌚💙' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
